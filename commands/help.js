...
module.exports = {
    ...
    run: async(client, message, args) =>{
        ...
        if (!args.length) {
            ...
            .setTitle("\<:y_:842221758500569088> Here\'s a list of all my commands:")
            ...
            return message.author.send(data, { split: true })
                .then(() => {
                    ...
                    .setDescription("\<:y_:842221758500569088> I\'ve sent you a DM with all my commands!")
                    .setColor("#77dd77")
                ...
                .catch(error => {
                    ...
                    .setDescription("\<:x_:842221675775787019> it seems like I can\'t DM you! Do you have DMs disabled?")
                    .setColor("#ff6961")
                    .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
        ...
        if (!command) {
            ...
            .setDescription("\<:x_:842221675775787019> That\'s not a valid command!")
            .setColor("#ff6961")
            .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
