...
module.exports = {
    ...
    run: async (client, message, args) => {
        if (message.member.id != "564135243225759752"){
            ...
            .setDescription("\<:x_:842221675775787019> Sorry only **Embox** can run this command")
            .setColor("#ff6961")
        ...
        if(!args[0]){
            ...
            .setDescription("\<:x_:842221675775787019> Incorrect usage! +reload (command)")
            .setColor("#ff6961")
            .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
        ...
        try {
            ...
            .setDescription(`\<:y_:842221758500569088> You have reloaded the command \`${command}\`** **successfully!`)
            .setColor("#77dd77")
            .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
            ...
            .addFields(
                { name:`\<:x_:842221675775787019> There was an error trying to reload **${command}**:`, value: `\`${error.message}\`` },
            )
            .setColor("#ff6961")
            .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
