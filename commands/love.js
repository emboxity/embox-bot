...
module.exports = {
    name: 'love',
    description: 'Uses Embox Bot/s love meter to determine love percentages.',
    cooldown: 1,
    guildOnly: true,
    run: async(client, message, args) =>{
        ...
        if (!args[0]) {
            ...
            .setDescription("\<:x_:842221675775787019> Incorrect usage! +love (love2)")
            .setColor("#ff6961")
        ...
        if (args[1]){
            ...
            const tenlove1 = new Discord.MessageEmbed() 
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :heart:  :heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :heart:  :heart:  :heart:  :broken_heart:  :broken_heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :broken_heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :broken_heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :broken_heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
                ...
                .setDescription(`${love2} x ${love3}`)
                .addFields(
                {name: `${random}%`, value: `:heart: :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :heart:  :heart:`},
                )
                .setColor("#FF6347")
                .setFooter('Embox Bot * made by shiba#2254',client.user.displayAvatarURL())
                .setAuthor(message.author.username, message.author.displayAvatarURL())
